    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-light-bg to-light-bg dark:from-dark-bg dark:to-dark-bg text-white font-mono">
            <div className="min-h-full flex flex-col">
                <nav className="bg-light-bg dark:bg-dark-bg fixed top-0 left-0 right-0 z-50 shadow-md">
                    ...
                    <div className="bg-dark-bg/80 dark:bg-light-bg/80 my-progress-bar"></div>
                </nav>
                ...
                <footer className="py-4 md:py-6 bg-transparent shadow-md mt-4">
                    <div className="max-w-7xl mx-auto px-4 flex justify-center items-center gap-4 md:gap-0 text-center md:text-left">
                        {/* Copyright Text */}
                        <p className="text-xs md:text-sm flex items-center gap-1 text-dark-bg dark:text-light-bg">
