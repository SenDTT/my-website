...
export default function Contact() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-dark-contactBg dark:bg-light-contactBg text-light-text dark:text-dark-text">
            <div className="max-w-7xl w-full p-4 md:p-6 bg-light-contactBg dark:bg-dark-contactBg rounded-lg flex flex-col md:flex-row justify-center gap4">
                <div className='w-1/2 flex justify-center items-center mb-4 md:mb-0 animate-fade-in-delay'>
                    <img src={profileImage} alt="Profile" className="w-full" />
                </div>
                <div className='flex flex-col items-center justify-center w-full max-w-sm md:max-w-lg p-4 md:p-6 gap-2'>
